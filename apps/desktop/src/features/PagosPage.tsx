    ...
    <div className="space-y-8 max-w-[1600px] mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-lg relative overflow-hidden">
          ...
          <div className="mt-4">
            <div className="text-3xl font-extrabold text-amber-400">${totalSales.toFixed(2)}</div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-extrabold text-slate-900 mt-1">${cashSales.toFixed(2)}</div>
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-extrabold text-slate-900 mt-1">${yapePlinSales.toFixed(2)}</div>
            <span className="text-[11px] text-slate-400 mt-1 block">
        ...
        <div className="bg-white p-6 rounded-3xl border border-slate-200/80 shadow-sm flex items-center justify-between">
          <div>
            ...
            <div className="text-2xl font-extrabold text-slate-900 mt-1">${cardSales.toFixed(2)}</div>
            <span className="text-[11px] text-slate-400 mt-1 block">
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-xs font-bold uppercase text-slate-700 mb-1">Monto de la Comanda ($)</label>
                <input
                  type="number"
                  step="0.50"
                  placeholder="0.00"
              ...
              <div>
                <label className="block text-xs font-bold uppercase text-slate-700 mb-1">Efectivo Recibido del Cliente ($)</label>
                <input
                  type="number"
                  step="0.50"
                  placeholder="0.00"
            ...
            <form onSubmit={handleConfirmCloseShift} className="p-6 space-y-5">
              ...
              <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200 space-y-2 text-xs">
                <div className="flex justify-between">
                  ...
                  <strong className="text-slate-900 text-sm font-extrabold">${totalSales.toFixed(2)}</strong>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-purple-700">${yapePlinSales.toFixed(2)}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Tarjetas POS:</span>
                  <span className="font-bold text-blue-700">${cardSales.toFixed(2)}</span>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Ej: Cuadre de caja exacto. Se deja $100 de sencillo en caja."
